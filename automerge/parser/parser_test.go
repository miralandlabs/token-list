...
var testData = []string{`
    },
    {
      ...
      "name": "GremWorld",
      "decimals": 9,
      "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/8tGqYibsn9ZYv7513DLyNHUn5pBGKektsg4gKrMPfQrF/logo.jpg",
      "tags": [
        "Metaverse"
      ]
`,
	`
   {
     ...
     "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/2poo1w1DL6yd2WNTCnNTzDqkC6MBXq7axo77P16yrBuf/icon.png",
     "decimals": 6,
   ...
   },
   {
     ...
     "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/PaiYwHYxr4SsEWox9YmyBNJmxVG7GdauirbBcYGB7cJ/icon.png",
     "decimals": 6,
   ...
   },
   {
     ...
     "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/SLPbsNrLHv8xG4cTc4R5Ci8kB9wUPs6yn6f7cKosoxs/icon.png",
     "decimals": 8,
   ...
   },
   {
     ...
     "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/pBTCmyG7FaZx4uk3Q2pT5jHKWmWDn84npdc7gZXpQ1x/icon.png",
     "decimals": 8,
   ...
   },
   {
     ...
     "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/CLPKiHjoU5HwpPK5L6MBXHKqFsuzPr47dM1w4An3Lnvv/icon.png",
     "decimals": 6,
...
`,
	`    {
      ...
      "name": "Toffee Token",
      "decimals": 0,
      "logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/476ZdKh1xue32zNzFWvnyaDEncrBEdq99sDiZXSGyyJu/logo.png",
      "tags": [
        "utility-token"
      ],
      "extensions": {}
...
}
{
	...
	"name": "HotoketCoin",
	"decimals": 8,
	"logoURI": "https://raw.githubusercontent.com/miralandlabs/token-list/main/assets/mainnet/9qXxEVGagc9ccd6b135Z8ZLr4VAWUd7T5KcmMyjYKBdB/logo.png",
	"tags":[],
	"extensions":{}
}`,
}
